...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gm1 }\OtherTok{\textless{}{-}} \FunctionTok{glmer}\NormalTok{(}\FunctionTok{cbind}\NormalTok{(incidence, size }\SpecialCharTok{{-}}\NormalTok{ incidence) }\SpecialCharTok{\textasciitilde{}}\NormalTok{ period }\SpecialCharTok{+}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{|}\NormalTok{ herd),}
              \AttributeTok{data =}\NormalTok{ cbpp, }\AttributeTok{family =}\NormalTok{ binomial)}
\FunctionTok{tab\_model}\NormalTok{(gm1)}
\end{Highlighting}
\end{Shaded}
