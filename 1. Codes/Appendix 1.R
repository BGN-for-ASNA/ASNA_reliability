...
error.rates <- function(R, p.side = "two.side"){
  ...
  if(p.side == "rigth.side"){
    d1 = data.frame(
      ...
      "two.side" = rep(TRUE, 2),
      "approches" = c("Parametric", "Nertwork permutations"),
      "strength" = c(sum(R[R$FemPhenotypeBias == T & R$test %in% "Strength.parametric",]$p_value_rigth_side>0.05)*100/nrow(R[R$FemPhenotypeBias == T & R$test %in% "Strength.parametric",]),
                     sum(R[R$FemPhenotypeBias == T & R$test %in% "Strength.network",]$p_value_rigth_side >0.05)*100/nrow(R[R$FemPhenotypeBias == T & R$test %in% "Strength.network",])),
      "eigenvector" = c(sum(R[R$FemPhenotypeBias == T & R$test %in% "Eigen.parametric",]$p_value_rigth_side>0.05)*100/nrow(R[R$FemPhenotypeBias == T & R$test %in% "Eigen.parametric",]),
    ...
    d2 =  data.frame(
      ...
      "two.side" = rep(TRUE, 2),
      "approches" = c("Parametric", "Nertwork permutations"),
      "strength" = c(sum(R[R$FemPhenotypeBias == T & R$test %in% "Strength.parametric.corrected",]$p_value_rigth_side>0.05)*100/nrow(R[R$FemPhenotypeBias == T & R$test %in% "Strength.parametric.corrected",]),
                     sum(R[R$FemPhenotypeBias == T & R$test %in% "Strength.network.corrected",]$p_value_rigth_side >0.05)*100/nrow(R[R$FemPhenotypeBias == T & R$test %in% "Strength.network.corrected",])),
      "eigenvector" = c(sum(R[R$FemPhenotypeBias == T & R$test %in% "Eigen.parametric.corrected",]$p_value_rigth_side>0.05)*100/nrow(R[R$FemPhenotypeBias == T & R$test %in% "Eigen.parametric.corrected",]),
    ...
    d3 = data.frame(
      ...
      "two.side" = rep(TRUE, 2),
      "approches" = c("Parametric", "Nertwork permutations"),
      "strength" = c(sum(R[R$FemPhenotypeBias == F & R$test %in% "Strength.parametric",]$p_value_rigth_side<0.05)*100/nrow(R[R$FemPhenotypeBias == F & R$test %in% "Strength.parametric",]),
                     sum(R[R$FemPhenotypeBias == F & R$test %in% "Strength.network",]$p_value_rigth_side <0.05)*100/nrow(R[R$FemPhenotypeBias == F & R$test %in% "Strength.network",])),
      "eigenvector" = c(sum(R[R$FemPhenotypeBias == F & R$test %in% "Eigen.parametric",]$p_value_rigth_side<0.05)*100/nrow(R[R$FemPhenotypeBias == F & R$test %in% "Eigen.parametric",]),
    ...
    d4 = data.frame(
      ...
      "two.side" = rep(TRUE, 2),
      "approches" = c("Parametric", "Nertwork permutations"),
      "strength" = c(sum(R[R$FemPhenotypeBias == F & R$test %in% "Strength.parametric.corrected",]$p_value_rigth_side<0.05)*100/nrow(R[R$FemPhenotypeBias == F & R$test %in% "Strength.parametric.corrected",]),
                     sum(R[R$FemPhenotypeBias == F & R$test %in% "Strength.network.corrected",]$p_value_rigth_side <0.05)*100/nrow(R[R$FemPhenotypeBias == F & R$test %in% "Strength.network.corrected",])),
      "eigenvector" = c(sum(R[R$FemPhenotypeBias == F & R$test %in% "Eigen.parametric.corrected",]$p_value_rigth_side<0.05)*100/nrow(R[R$FemPhenotypeBias == F & R$test %in% "Eigen.parametric.corrected",]),
  ...
  if(p.side == "left.side"){
    d1 = data.frame(
      ...
      "two.side" = rep(TRUE, 2),
      "approches" = c("Parametric", "Nertwork permutations"),
      "strength" = c(sum(R[R$FemPhenotypeBias == T & R$test %in% "Strength.parametric",]$p_value_left_side>0.05)*100/nrow(R[R$FemPhenotypeBias == T & R$test %in% "Strength.parametric",]),
                     sum(R[R$FemPhenotypeBias == T & R$test %in% "Strength.network",]$p_value_left_side >0.05)*100/nrow(R[R$FemPhenotypeBias == T & R$test %in% "Strength.network",])),
      "eigenvector" = c(sum(R[R$FemPhenotypeBias == T & R$test %in% "Eigen.parametric",]$p_value_left_side>0.05)*100/nrow(R[R$FemPhenotypeBias == T & R$test %in% "Eigen.parametric",]),
    ...
    d2 =  data.frame(
      ...
      "two.side" = rep(TRUE, 2),
      "approches" = c("Parametric", "Nertwork permutations"),
      "strength" = c(sum(R[R$FemPhenotypeBias == T & R$test %in% "Strength.parametric.corrected",]$p_value_left_side>0.05)*100/nrow(R[R$FemPhenotypeBias == T & R$test %in% "Strength.parametric.corrected",]),
                     sum(R[R$FemPhenotypeBias == T & R$test %in% "Strength.network.corrected",]$p_value_left_side >0.05)*100/nrow(R[R$FemPhenotypeBias == T & R$test %in% "Strength.network.corrected",])),
      "eigenvector" = c(sum(R[R$FemPhenotypeBias == T & R$test %in% "Eigen.parametric.corrected",]$p_value_left_side>0.05)*100/nrow(R[R$FemPhenotypeBias == T & R$test %in% "Eigen.parametric.corrected",]),
    ...
    d3 = data.frame(
      ...
      "two.side" = rep(TRUE, 2),
      "approches" = c("Parametric", "Nertwork permutations"),
      "strength" = c(sum(R[R$FemPhenotypeBias == F & R$test %in% "Strength.parametric",]$p_value_left_side<0.05)*100/nrow(R[R$FemPhenotypeBias == F & R$test %in% "Strength.parametric",]),
                     sum(R[R$FemPhenotypeBias == F & R$test %in% "Strength.network",]$p_value_left_side <0.05)*100/nrow(R[R$FemPhenotypeBias == F & R$test %in% "Strength.network",])),
      "eigenvector" = c(sum(R[R$FemPhenotypeBias == F & R$test %in% "Eigen.parametric",]$p_value_left_side<0.05)*100/nrow(R[R$FemPhenotypeBias == F & R$test %in% "Eigen.parametric",]),
    ...
    d4 = data.frame(
      ...
      "two.side" = rep(TRUE, 2),
      "approches" = c("Parametric", "Nertwork permutations"),
      "strength" = c(sum(R[R$FemPhenotypeBias == F & R$test %in% "Strength.parametric.corrected",]$p_value_left_side<0.05)*100/nrow(R[R$FemPhenotypeBias == F & R$test %in% "Strength.parametric.corrected",]),
                     sum(R[R$FemPhenotypeBias == F & R$test %in% "Strength.network.corrected",]$p_value_left_side <0.05)*100/nrow(R[R$FemPhenotypeBias == F & R$test %in% "Strength.network.corrected",])),
      "eigenvector" = c(sum(R[R$FemPhenotypeBias == F & R$test %in% "Eigen.parametric.corrected",]$p_value_left_side<0.05)*100/nrow(R[R$FemPhenotypeBias == F & R$test %in% "Eigen.parametric.corrected",]),
